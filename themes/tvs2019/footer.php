 ...
 */
$id = get_the_ID();
$custom_sidebar = get_post_meta( $id, '_trade_footer_custom_widget_area', true );
$footer_hide = get_post_meta( $id, '_trade_footer_hide', true );
$footer_columns = get_theme_mod( 'trade_footer_columns', '3' );
$footer_class = '';
	...
	<footer id="footer" class="<?php echo $footer_class; ?>">
		<div class="inside clear">
			...
			<div class="secondary clear">
				<div class="inside">
				<?php $footer_left = get_theme_mod( 'trade_footer_left' ); ?>
				<?php $footer_right = get_theme_mod( 'trade_footer_right' ); ?>
