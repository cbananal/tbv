...
* Trade metaboxes to be used on post edit screens.
* [Trade forms to be used on an options pages](https://github.com/WebDevStudios/CMB2/wiki/Using-CMB-to-create-an-Admin-Theme-Options-Page).
* Trade forms to handle user meta and display them on user profile add/edit pages.
...
* Traded 'cmb_show_on' filter to define your own Show On Filters, props [@billerickson](https://github.com/billerickson)
