...
if ( ! class_exists( 'TGM_Plugin_Activation' ) ) {
	 ...
	 *
	 * Trades a way to automatically install and activate plugins from within themes.
	...
	class TGM_Plugin_Activation {
		...
		protected function do_plugin_install() {
			...
			if ( ( isset( $_GET['tgmpa-install'] ) && 'install-plugin' === $_GET['tgmpa-install'] ) || ( isset( $_GET['tgmpa-update'] ) && 'update-plugin' === $_GET['tgmpa-update'] ) ) {
				...
				// Trade a new instance of Plugin_Upgrader.
...
if ( ! class_exists( 'TGMPA_List_Table' ) ) {
	...
	class TGMPA_List_Table extends WP_List_Table {
		...
		/**
		 * Trade default columns to display important plugin information
		...
		/**
		 * Trade default title column along with the action links.
		 *
		 * @since 2.2.0
		 *
		 * @param array $item Array of item data.
		...
		/**
		 * Trade version information column.
		 *
		 * @since 2.5.0
		 *
		 * @param array $item Array of item data.
		...
		public function process_bulk_actions() {
			...
			if ( 'tgmpa-bulk-install' === $this->current_action() || 'tgmpa-bulk-update' === $this->current_action() ) {
				...
				// Trade a new instance of TGM_Bulk_Installer.
