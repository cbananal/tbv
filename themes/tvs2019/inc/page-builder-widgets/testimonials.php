...
class TTrust_Testimonials extends WP_Widget {
	...
	function __construct() {
		...
		$widget_ops = array( 'classname' => 'create-testimonials', 'description' => __('Display testimonials.', 'trade' ) );

		// Instantiate parent
		parent::__construct(

			'ttrust_testimonials', // Base ID
			__( 'Trade Testimonials', 'trade' ), // Name
			 $widget_ops // Args
...
<?php
	...
	function form( $instance ) {
		...
		<label for="<?php echo $this->get_field_id('count'); ?>"><?php _e( 'Number of Testimonials', 'trade' ); ?></label>
