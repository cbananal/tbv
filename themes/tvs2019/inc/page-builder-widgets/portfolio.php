...
class TTrust_Portfolio extends WP_Widget {
	...
	function __construct() {
		...
		$widget_ops = array( 'classname' => 'trade-portfolio', 'description' => __('Display portfolio projects.', 'trade' ) );

		// Instantiate parent
		parent::__construct(

			'ttrust_portfolio', // Base ID
			__( 'Trade Portfolio', 'trade' ), // Name
			 $widget_ops // Args
			...
			?>
				...
				<div class="projects <?php echo $layout_class; ?> <?php echo $column_class; ?>">
					...
					<div class="load-more-holder">
						...
						<div class="loading hidden button" style="background:<?php echo $load_more_color; ?>; color:<?php echo $load_more_text_color; ?>;"><?php _e( "Loading", 'trade'); ?></div>
					</div>
					<?php } ?>
				</div><!-- .projects -->
...
<?php
	...
	function form( $instance ) {
		...
		<p><label for="<?php echo $this->get_field_id( 'title' ); ?>"><?php _e( 'Name', 'trade' ); ?></label>
		<input class="widefat" id="<?php echo $this->get_field_id( 'title' ); ?>" name="<?php echo $this->get_field_name( 'title' ); ?>" type="text" value="<?php echo $title; ?>" /></p>
		
		<p>
		    
			<label for="<?php echo $this->get_field_id('show_filter'); ?>"><?php _e( 'Show Filter', 'trade' ); ?></label>
		...
		<p>
		<label for="<?php echo $this->get_field_id('filter_alignment'); ?>"><?php _e('Filter Alignment', 'trade'); ?></label>
		...
		<p>
		<label for="<?php echo $this->get_field_id('count'); ?>"><?php _e( 'Number of Projects', 'trade' ); ?></label>
		<input type="number" name="<?php echo $this->get_field_name( 'count' ); ?>" min="1" max="99" value="<?php echo $count; ?>">
		</p>
		
		<p>
		<label for="<?php echo $this->get_field_id('thumb_proportions'); ?>"><?php _e('Featured Image Proportions for Non-masonry Layout ', 'trade'); ?></label>
		...
		<p>
		<label for="<?php echo $this->get_field_id('layout'); ?>"><?php _e('Layout', 'trade'); ?></label>
		...
		<p>
		<label for="<?php echo $this->get_field_id('columns'); ?>"><?php _e('Columns', 'trade'); ?></label>
		...
		<p>
		<label for="<?php echo $this->get_field_id('skills'); ?>"><?php _e('Show only certain skills', 'trade'); ?></label>
		<?php
		...
		<p>
		<label for="<?php echo $this->get_field_id('orderby'); ?>"><?php _e('Order By', 'trade'); ?></label>
		...
		<p>
		<label for="<?php echo $this->get_field_id('order'); ?>"><?php _e('Order', 'trade'); ?></label>
		...
		<p>
		<label for="<?php echo $this->get_field_id('hover_effect'); ?>"><?php _e('Hover Effect', 'trade'); ?></label>
		...
		<p>
		    <label for="<?php echo $this->get_field_id( 'hover_color' ); ?>" style="display:block;"><?php _e( 'Hover Color', 'trade' ); ?></label> 
		...
		<p>
		    <label for="<?php echo $this->get_field_id( 'hover_text_color' ); ?>" style="display:block;"><?php _e( 'Hover Text Color', 'trade' ); ?></label> 
		...
		<p>
		<label for="<?php echo $this->get_field_id('show_skills'); ?>"><?php _e('Show Skills on Hover', 'trade'); ?></label>
		...
		<p>		    
			<label for="<?php echo $this->get_field_id('show_load_more'); ?>"><?php _e( 'Show Load More Button', 'trade' ); ?></label>
		...
		<p>
		    <label for="<?php echo $this->get_field_id( 'load_more_color' ); ?>" style="display:block;"><?php _e( 'Load More Button Color', 'trade' ); ?></label> 
		...
		<p>
		    <label for="<?php echo $this->get_field_id( 'load_more_text_color' ); ?>" style="display:block;"><?php _e( 'Load More Button Text Color', 'trade' ); ?></label> 
		...
		<p>		    
			<label for="<?php echo $this->get_field_id('enable_lightbox'); ?>"><?php _e( 'Enable Lightbox', 'trade' ); ?></label>
