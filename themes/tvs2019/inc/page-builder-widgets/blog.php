...
class TTrust_Blog extends WP_Widget {
	...
	function __construct() {
		...
		$widget_ops = array( 'classname' => 'create-blog', 'description' => __('Display blog.', 'trade' ) );

		// Instantiate parent
		parent::__construct(

			'ttrust_blog', // Base ID
			__( 'Trade Blog', 'trade' ), // Name
			 $widget_ops // Args
	...
	public function widget( $args, $instance ) {
			...
			?>
				<div id="<?php echo $args['widget_id']; ?>" class="blog clear <?php echo $layout_class; ?> <?php echo $column_class; ?> <?php echo $alignment_class; ?> <?php echo $boxed_class; ?>">
...
<?php
	...
	function form( $instance ) {
		...
		<label for="<?php echo $this->get_field_id('count'); ?>"><?php _e( 'Number of Posts', 'trade' ); ?></label>
		<input type="number" name="<?php echo $this->get_field_name( 'count' ); ?>" min="1" max="99" value="<?php echo $count; ?>">

		<p>
		<label for="<?php echo $this->get_field_id('category'); ?>"><?php _e('Category (leave blank to show all)', 'trade'); ?></label>
		...
		<p>
		<label for="<?php echo $this->get_field_id('alignment'); ?>"><?php _e('Content Alignment', 'trade'); ?></label>
		...
		<p>
			...
			<label for="<?php echo $this->get_field_id('show_excerpt'); ?>"><?php _e( 'Show Excerpt', 'trade' ); ?></label>
		...
		<p>
		    <label for="<?php echo $this->get_field_id( 'carousel-nav-color' ); ?>" style="display:block;"><?php _e( 'Carousel Nav Color', 'trade' ); ?></label> 
