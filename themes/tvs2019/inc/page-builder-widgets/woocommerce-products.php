...
class TTrust_Products extends WP_Widget {
	...
	function __construct() {
		...
		$widget_ops = array( 'classname' => 'create-products', 'description' => __('Display Woocommerce Products.', 'trade' ) );

		// Instantiate parent
		parent::__construct(

			'ttrust_products', // Base ID
			__( 'Trade Woocommerce Products', 'trade' ), // Name
			 $widget_ops // Args
...
<?php
	...
	function form( $instance ) {
		...
		<label for="<?php echo $this->get_field_id('count'); ?>"><?php _e( 'Number of Products', 'trade' ); ?></label>
		...
		<p>
		<label for="<?php echo $this->get_field_id('categories'); ?>"><?php _e('Show only certain categories', 'trade'); ?></label>
		<?php
		...
		<p>
		<label for="<?php echo $this->get_field_id('layout'); ?>"><?php _e('Show Featured', 'trade'); ?></label>
