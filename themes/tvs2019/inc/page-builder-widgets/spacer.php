...
class TTrust_Spacer extends WP_Widget {
	...
	function __construct() {
		...
		$widget_ops = array( 'classname' => 'trade-spacer', 'description' => __('Adds empty vertical space.', 'trade' ) );

		// Instantiate parent
		parent::__construct(

			'ttrust_spacer', // Base ID
			__( 'Trade Spacer', 'trade' ), // Name
			 $widget_ops // Args
	...
	public function widget( $args, $instance ) {
			...
			echo $before_widget;
			?>
				<div id="<?php echo $args['widget_id']; ?>" class="trade-spacer" style="height: <?php echo $min_height;?>px;"></div>
			<?php
		echo $after_widget; 
	...
	function form( $instance ) {
		...
		<p>
		<label for="<?php echo $this->get_field_id('count'); ?>"><?php _e( 'Height in pixels', 'trade' ); ?></label>
