 ...
 */
add_filter ( 'woocommerce_add_to_cart_redirect', 'trade_wc_redirect_to_checkout' );

function trade_wc_redirect_to_checkout($cart) {
	global $woocommerce;
 ...
 * Define image sizes
 */
function trade_wc_image_dimensions() {
	global $pagenow;
...
add_action( 'after_switch_theme', 'trade_wc_image_dimensions', 1 );
...
function woocommerce_header_add_to_cart_fragment( $fragments ) {
	...
	ob_start();
	?>
	<a class="cart-icon cart-contents right open" href="<?php echo $woocommerce->cart->get_cart_url(); ?>" title="<?php _e('View your shopping cart', 'trade'); ?>">
...
$products_per_page = get_theme_mod( 'trade_shop_product_count', 12 );
