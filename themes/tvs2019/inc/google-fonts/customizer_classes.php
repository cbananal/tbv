...
function trade_gfp_custom_controls( $wp_customize ) {

	// Description

	class Trade_GFP_Tag extends WP_Customize_Control {
		public $type = 'tag';
	...
	class Trade_GFP_Autocomplete extends WP_Customize_Control {
...
add_action( 'customize_register', 'trade_gfp_custom_controls' );
?>