  ...
  class Walker_Nav_Menu_Custom extends Walker_Nav_Menu {
    ...
    function start_el( &$output, $item, $depth = 0, $args = array(), $id = 0 ) {
      ...
      if( $depth == 1 && isset( $this->menu_type[$item->menu_item_parent] ) ) {
        $bs_col = trade_get_bootstrap( $this->child_count );
      }
      ...
      $item_output = $args->before;
        ...
        // adding icon
        $item_output .= ( ! empty( $item->icon ) ) ? '<i class="'. trade_icon_class( $item->icon ) .'"></i>' : '';
  ...
  function start_el( &$output, $item, $depth = 0, $args = array(), $id = 0 ) {
    ...
    <li id="menu-item-<?php echo $item_id; ?>" class="<?php echo implode(' ', $classes ); ?>">
      <dl class="menu-item-bar">
        <dt class="menu-item-handle">
          ...
          <span class="item-controls">
            ...
            <!-- Mega Labels Action -->
            <?php do_action('trade_mega_menu_labels'); ?>
            <!-- /Mega Labels Action -->
      ...
      <div class="menu-item-settings" id="menu-item-settings-<?php echo $item_id; ?>">
        ...
        <!-- Mega Menu Fields-->
        <?php do_action('trade_mega_menu_fields', $item_id, $item); ?>
        <!-- /Mega Menu Fields-->
