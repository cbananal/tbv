...
<?php
	...
	$posts_count        = get_theme_mod( 'trade_recent_posts_count', 3 );
	$recent_posts_title = get_theme_mod( 'trade_recent_posts_title', __( 'Recent Posts', 'trade' ) );
	$blog_page_id       = get_option( 'page_for_posts' );
	$recent_summary     = create_clean_and_tag( get_theme_mod( 'trade_recent_posts_summary' ) );
	$background_image   = esc_url( get_theme_mod( 'trade_posts_background_image' ) );
